    ...
    return (
        <>
            <header className={`lg:hidden fixed top-0 left-0 w-full bg-white z-[60] transition-all duration-300 border-b border-gray-100 ${isScrolled ? 'shadow-md' : ''}`}>
                ...
                <div className="flex items-center bg-gray-700 justify-between px-4 py-1.5 animate-in fade-in slide-in-from-top-2 duration-300">
                ...
                <div className="px-1.5 py-1.5 bg-gray-700">
                    <HeaderSearch />
                </div>

                {/* Bottom Row: Categories Carousel */}
                {!isHome && !pathname.startsWith('/product/') && !hideHeaderCategories && (
                    <div className={`border-t border-gray-50 overflow-x-auto scrollbar-hide bg-white transition-all duration-300 py-1.5`}>
