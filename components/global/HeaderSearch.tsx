        ...
        <div className="flex-1 max-w-xl relative">
            <div className={`flex items-center w-full bg-white rounded-md transition-all duration-200 border border-brand-green ${focused ? 'shadow-md ring-2 ring-brand-green/10' : ''}`}>
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-3 py-3 md:px-4 md:py-2 rounded-r-md bg-green-600 text-white text-[10px] md:text-sm font-semibold transition hover:bg-[#0c4a9e]/90 disabled:cursor-not-allowed disabled:bg-green-700 disabled:text-white-500"
                >
